...
# PCA plot
pca_result <- pca(X)
plotIndiv(pca_result, group = breast.TCGA$data.train$subtype, 
          legend = TRUE, title = "PCA of protein expression")

# PLS-DA plot
plsda_result <- plsda(X, Y)
plotIndiv(plsda_result, group = breast.TCGA$data.train$subtype, 
...
We can visually inspect the component loadings to determine the optimal number of components to include in downstream analyses.
